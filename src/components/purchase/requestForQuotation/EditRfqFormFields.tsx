...
interface ReactHookFormProps {
  ...
  onPurchaseRequestChange?: (purchaseRequestId: string) => void;
...
type EditRfqFormFieldsProps = ReactHookFormProps | SimpleProps;

export function EditRfqFormFields(props: EditRfqFormFieldsProps) {
  ...
  const watchedExpiryDate = isReactHookForm
    ? reactHookFormProps.watch("expiry_date")
    : simpleProps.formData.expiry_date;
  const watchedPurchaseRequest = isReactHookForm
    ? reactHookFormProps.watch("purchase_request")
    : simpleProps.formData.purchase_request;
      ...
      <div className="flex-1">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          ...
          >
            ...
            >
              <Select
                value={(watchedPurchaseRequest as string) || ""}
                onValueChange={(value) => {
                  handleSelectChange("purchase_request", value);
                  // Trigger auto-population when purchase request changes
                  if (isReactHookForm) {
                    reactHookFormProps.onPurchaseRequestChange?.(value);
                  } else {
                    simpleProps.onPurchaseRequestChange?.(value);
                  }
                }}
                disabled={
                  isReactHookForm
                ...
                disabled={
                  isReactHookForm
                    ? reactHookFormProps.isLoadingCurrencies ||
                      reactHookFormProps.disableFields
                    : simpleProps.isLoadingCurrencies ||
                      simpleProps.disableFields
                }
              >
                <SelectTrigger
                  className="w-full h-11 border border-gray-400 rounded bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                ...
                disabled={
                  isReactHookForm
                    ? reactHookFormProps.isLoadingVendors ||
                      reactHookFormProps.disableFields
                    : simpleProps.isLoadingVendors || simpleProps.disableFields
                }
              >
                <SelectTrigger
                  className="w-full h-11 border border-gray-400 rounded bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
              ...
              >
                <Input
                  ...
                  {...(isReactHookForm
                    ...
                    : {
                        value: (watchedExpiryDate as string) || "",
                        onChange: (e: React.ChangeEvent<HTMLInputElement>) =>
